...
class CM_Custom_Reports_Backend
{
    ...
    {
        $reportUri = add_query_arg(array('cmcr_report' => $slug), self::getReportListUrl());
        return $reportUri;
    }

    public static function getReportListUrl()
    {
        $reportUri = add_query_arg(array('page' => 'cm-custom-reports'), admin_url('admin.php'));
        return $reportUri;
    }
    ...
    public static function cmcr_admin_menu()
    {
        ...
        add_submenu_page(CMCR_SLUG_NAME, 'Reports', __('Reports', CMCR_SLUG_NAME), 'manage_options', CMCR_SLUG_NAME, array(__CLASS__, 'cmcr_display_page'));
...
//        add_submenu_page(CMCR_SLUG_NAME, 'Help', __('Help', CMCR_SLUG_NAME), 'manage_options', CMCR_SLUG_NAME . '-help', array(__CLASS__, 'cmcr_display_page'));
        add_submenu_page(CMCR_SLUG_NAME, 'Pro', __('Pro', CMCR_SLUG_NAME), 'manage_options', CMCR_PRO_OPTION, array(__CLASS__, 'cmcr_display_page'));
        add_submenu_page(CMCR_SLUG_NAME, 'About', __('About', CMCR_SLUG_NAME), 'manage_options', CMCR_SLUG_NAME . '-about', array(__CLASS__, 'cmcr_display_page'));
        add_submenu_page(CMCR_SLUG_NAME, 'User Guide', __('User Guide', CMCR_SLUG_NAME), 'manage_options', CMCR_SLUG_NAME . '-userguide', array(__CLASS__, 'cmcr_display_page'));

        if( current_user_can('manage_options') )
        {
            $submenu[CMCR_SLUG_NAME][999] = array('Yearly membership offer', 'manage_options', self::PAGE_YEARLY_OFFER);
    ...
    public static function admin_head()
    {
        echo '<style type="text/css">
        		#toplevel_page_cm-custom-reports a[href*="cm-wordpress-plugins-yearly-membership"] {color: white;}
    			...
    			#toplevel_page_cm-custom-reports a[href*="cm-wordpress-plugins-yearly-membership"]:before {vertical-align: bottom;}
